...
%                 lb = [tapXfmr1_min, tapXfmr2_min, tapXfmr3_min, tapXfmr4_min, tapXfmr5_min, unitCB1_min, unitCB2_min, unitCB3_min, unitCB4_min]
%                 Here, tapXfmr1_min, tapXfmr2_min, tapXfmr3_min, tapXfmr4_min and tapXfmr5_min are the minimum possible tap number for the respective transformer, e.g., -16.
%                 unitCB1_min, unitCB2_min,unitCB3_min and unitCB4_min are the minimum available units in the respective capacitor bank, e.g., 0.
%  ub: Upper limit for the unknown variables. It is a row vector.
%                 ub = [tapXfmr1_max, tapXfmr2_max, tapXfmr3_max, tapXfmr4_max, tapXfmr5_max, unitCB1_max, unitCB2_max, unitCB3_max, unitCB4_max]
%                 Here, tapXfmr1_max, tapXfmr2_max, tapXfmr3_max, tapXfmr4_max and tapXfmr5_max are the maximum possible tap number for the respective transformer, e.g., 16.
%                 unitCB1_max, unitCB2_max,unitCB3_max and unitCB4_max are the maximum available units in the respective capacitor bank, e.g., 4.
%               
